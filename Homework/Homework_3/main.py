...
#                      31.5 Сделать if в котором будет условие:
#                      если target_currency равен ‘eur’, то в теле этого if
#                      в значении переменной currency_result высчитать сколько долларов
#                      получится при target_currency_amount и usd_eur_rate.
#                      Результат вывести в консоль (target_currency_amount, eur_item, “=”, currency_result, usd_item)
#                     31.6 Сделать elif в котором будет условие: если target_currency равен ‘uah’,
#                     то в теле этого if в значении переменной currency_result
#                     высчитать сколько долларов получится при target_currency_amount и usd_uah_rate.
...
if currency_convertor:
    ...
    target_currency = input('Введите USD_EUR, USD, RUB, BYN, CHF, UAH:')
    ...
    print('Unknow currency', currency_convertor)

# count = 0
# for i in currency_convertor (0, 1):
#     print('123456 =')


#
# if target_currency = int(input("Enter your EUR: ")):
#     # currency_result = target_currency_amount * usd_uah_rate
#     # print('target_currency_amount, eur_item, “=”', currency_result, usd_item)

#       м оставить else, при выполнений которого в консоль выведется (“Unknow currency”)
