...
item_1 = 4
print('пункт 1 =', item_1, type(item_1))
#  2. Создать переменную item_2 типа integer.
item_2 = 9
print('пункт 2 =', item_2, type(item_2))
...
print('print item_3 +=', item_3, type(item_3))
...
print('print item_3 =sqrt', item_3, type(item_3))
